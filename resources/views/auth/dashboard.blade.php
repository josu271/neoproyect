        ...
        <div class="offcanvas-body p-0">
            <nav class="bg-light border-end h-100">
                <ul class="nav flex-column p-3">
                    ...
                    {{-- Solo para Administrador: enlace Empleados --}}
                    @if(Auth::user()->RolEmpleado === 'Administrador')
                        <li class="nav-item mb-2">
                            <a class="nav-link {{ request()->routeIs('empleados.index') ? 'active fw-bold' : '' }}"
                    ...
                    @if(Auth::user()->RolEmpleado === ' Administrador' || Auth::user()->RolEmpleado === 'ADMINISTRADOR')
